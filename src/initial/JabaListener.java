...
public interface JabaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JabaParser#type}.
	 * @param ctx the parse tree
	 */
	void enterType( JabaParser.TypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link JabaParser#type}.
	 * @param ctx the parse tree
	 */
	void exitType( JabaParser.TypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JabaParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterMainDeclaration( JabaParser.MainDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link JabaParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitMainDeclaration( JabaParser.MainDeclarationContext ctx);
	/**
